...
mov r10, rcx
lea rax, data_base
vbroadcastss zmm13, dword ptr [rax]
vbroadcastss zmm7, dword ptr [rax+4]
vbroadcastss zmm8, dword ptr [rax+8]
vbroadcastss zmm9, dword ptr [rax+12]
vbroadcastss zmm10, dword ptr [rax+16]
vbroadcastss zmm11, dword ptr [rax+20]
vbroadcastss zmm12, dword ptr [rax+24]
mov rcx, r8
jmp @L2
align 32
@L1:
...
vbroadcastss zmm8, dword ptr [r9+40]
vmovups zmm5, zmmword ptr [r9+64]
vmovups zmm6, zmmword ptr [r9+128]
mov rcx, r8
jmp @L8
align 32
@L7:
...
vfmsub132ps zmm9, zmm17, dword bcst [r9+44]
vfmsub132ps zmm10, zmm18, dword bcst [r9+44]
vfmsub132ps zmm11, zmm19, dword bcst [r9+44]
vfmsub132ps zmm12, zmm20, dword bcst [r9+44]
vsubps zmm13, zmm21, zmm4
vsubps zmm14, zmm22, zmm4
vsubps zmm15, zmm23, zmm4
vsubps zmm16, zmm24, zmm4
vandps zmm17, zmm13, dword bcst [r9+48]
vandps zmm18, zmm14, dword bcst [r9+48]
vandps zmm19, zmm15, dword bcst [r9+48]
vandps zmm20, zmm16, dword bcst [r9+48]
vcmpltps k2, zmm17, dword bcst [r9+52]
vcmpltps k3, zmm18, dword bcst [r9+52]
vcmpltps k4, zmm19, dword bcst [r9+52]
vcmpltps k5, zmm20, dword bcst [r9+52]
...
vmovaps zmm15, zmm8
vmovaps zmm16, zmm8
vfmadd213ps zmm13, zmm0, dword bcst [r9+36]
vfmadd213ps zmm14, zmm1, dword bcst [r9+36]
vfmadd213ps zmm15, zmm2, dword bcst [r9+36]
vfmadd213ps zmm16, zmm3, dword bcst [r9+36]
vfmadd213ps zmm13, zmm0, dword bcst [r9+32]
vfmadd213ps zmm14, zmm1, dword bcst [r9+32]
vfmadd213ps zmm15, zmm2, dword bcst [r9+32]
vfmadd213ps zmm16, zmm3, dword bcst [r9+32]
...
vfmsub132ps zmm9, zmm11, dword bcst [r9+44]
vsubps zmm10, zmm12, zmm4
vandps zmm11, zmm10, dword bcst [r9+48]
vcmpltps k2, zmm11, dword bcst [r9+52]
vmovaps zmm0{k2}, zmm10
vxorps zmm9{k2}, zmm9, zmm9
vmovaps zmm10, zmm8
vfmadd213ps zmm10, zmm0, dword bcst [r9+36]
vfmadd213ps zmm10, zmm0, dword bcst [r9+32]
